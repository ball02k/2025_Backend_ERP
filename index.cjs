...
const tendersCreateRouter = require('./routes/tenders.create.cjs');
const tendersQnaRouter = require('./routes/tenders.qna.cjs');
const tendersPortalQnaRouter = require('./routes/tenders.portal.qna.cjs');
const tendersBuilderRouter = require('./routes/tenders.builder.cjs');
const tendersDocumentsRouter = require('./routes/tenders.documents.cjs');
const tendersWorkflowRouter = require('./routes/tenders.workflow.cjs');
const tendersInvitationsRouter = require('./routes/tenders.invitations.cjs');
const tendersClarificationsRouter = require('./routes/tenders.clarifications.cjs');
const tendersPackageCopyRouter = require('./routes/tenders.package-copy.cjs');
const packagesPricingRouter = require('./routes/packages.pricing.cjs');
...
const projectTendersRouter = require('./routes/projects.tenders.cjs');
const packagesRouter = require('./routes/packages.cjs');
const packagesActionsRouter = require('./routes/packages.actions.cjs');
const packagesDocumentsRouter = require('./routes/packages.documents.cjs');
...
const contractsDocumentsRouter = require('./routes/contracts.documents.cjs');
