...
const projectBodySchema = z.object({
  ...
  retentionPct: z.number().nonnegative().optional().nullable(),
  sitePostcode: z.string().trim().optional().nullable(),
  siteLat: z.coerce.number().optional().nullable(),
  siteLng: z.coerce.number().optional().nullable(),
  labels: z.array(z.string()).optional().nullable(),
  // Task 2.1: Project role fields
  role: z.enum(['PRINCIPAL_CONTRACTOR', 'SUBCONTRACTOR', 'DIRECT_TO_CLIENT']).optional().nullable(),
  projectRole: z.enum(['PRINCIPAL_CONTRACTOR', 'SUBCONTRACTOR', 'DIRECT_TO_CLIENT']).optional().nullable(),
  upstreamPartyType: z.enum(['MAIN_CONTRACTOR', 'CLIENT']).optional().nullable(),
  upstreamPartyId: z.number().int().optional().nullable(),
  upstreamContactId: z.number().int().optional().nullable(),
  upstreamContractRef: z.string().trim().optional().nullable(),
  upstreamPoNumber: z.string().trim().optional().nullable(),
});
