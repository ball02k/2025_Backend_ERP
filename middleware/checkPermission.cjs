const rolePerms = {
  ...
  PM: ['project:view', 'project:edit', 'procurement:issue', 'procurement:award', 'contracts:edit', 'contracts:issue', 'contracts:sign', 'programme:edit', 'jobs:view', 'jobs:create', 'jobs:update', 'jobs:delete', 'workers:view', 'workers:create', 'workers:update', 'workers:delete', 'equipment:view', 'equipment:create', 'equipment:update', 'equipment:delete', 'schedules:view', 'schedules:create', 'schedules:update', 'schedules:delete', 'timeentries:view', 'timeentries:create', 'timeentries:update', 'timeentries:delete', 'timeentries:submit', 'timeentries:approve'],
  QS: ['cvr:edit', 'cvr:close', 'financials:edit', 'contracts:edit', 'contracts:issue', 'contracts:sign', 'jobs:view', 'workers:view', 'equipment:view', 'schedules:view', 'timeentries:view'],
